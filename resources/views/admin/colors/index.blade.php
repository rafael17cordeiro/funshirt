    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-between items-end mb-6">
                <div>
                    <h2 class="text-2xl font-black text-gray-900 tracking-tight">Catálogo de Cores</h2>
                    <p class="text-sm text-gray-500 mt-1 font-medium">Cores base disponíveis para as t-shirts da loja.
                    </p>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 text-gray-500 font-semibold">
                            <tr>
                                <th scope="col" class="px-6 py-4 uppercase tracking-wider">Amostra</th>
                                <th scope="col" class="px-6 py-4 uppercase tracking-wider">Código (CSS)</th>
                                <th scope="col" class="px-6 py-4 uppercase tracking-wider w-1/3">Nome da Cor</th>
                            ...
                            @forelse($colors as $color)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @endphp
                                        <div class="block w-8 h-8 rounded-full border border-gray-200 shadow-sm"
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center justify-center text-gray-500">
                                            ...
                                            <p class="text-sm font-medium">Nenhuma cor registada no sistema.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
                ...
                @if(isset($colors) && method_exists($colors, 'hasPages') && $colors->hasPages())
